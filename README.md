...
> [!NOTE]   
> Por exemplo, a URL https://github.com/falvojr/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`jessicalorentino`" para a contribuição no repositório `dio-lab-open-source`.
...
##
<div align="center">Feito com 💙 por <a href="https://github.com/jessicalorentino">Jessie</a>.</div>
